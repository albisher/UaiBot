...
class AICommandExtractor:
    ...
    def format_ai_prompt(self, user_input, system_info):
        ...
        prompt = (
            ...
            "- ***IMPORTANT: For any step with operation 'system_command', the 'parameters' object MUST include a 'command' field with the exact shell command to execute for the user's OS. Do not leave it empty.***\n"
            "- For example, to open Firefox on macOS, use: {\"command\": \"open -a Firefox\"} in the parameters.\n\n"
            "---\n"
            ...
            "      \"parameters\": {\"command\": \"open -a Firefox\"},\n"
            "      \"confidence\": 0.98,\n"
            "      \"conditions\": null\n"
            "    }\n"
            "  ]\n"
            "}\n"
            "---\n"
            "Do NOT copy the example. Generate a plan for the user's actual request above.\n"
