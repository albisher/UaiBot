...
from app.core.ai.agent import LabeebAgent
from app.core.ai.tools.base_tool import LabeebTool
from app.core.ai.workflows.base_workflow import LabeebWorkflow
...
"""
    ...
    def switch_model(self):
        ...
        if self.config['default_ai_provider'] == 'ollama':
            from app.health_check.ollama_health_check import check_ollama_server
            ok, tags_json = check_ollama_server()
            if not ok:
