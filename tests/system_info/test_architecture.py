...
def test_module_imports():
    ...
    modules_to_test = [
        ...
        # Screen handler
        ("app.core.screen_handler.screen_manager", ["ScreenManager"]),
        ("app.core.screen_handler.session_manager", ["ScreenSessionHandler", "SessionManager"]),
...
def test_module_composition(quiet=True):
    ...
    print_subheader("Testing app.core.screen_handler.ScreenManager instantiation")
    try:
